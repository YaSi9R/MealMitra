...
export default function DonorHeader({ notificationCount = 0 }: DonorHeaderProps) {
    ...
    <header className="bg-white border-b border-gray-200 sticky top-0 z-40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          <Link href="/donor/dashboard" className="text-gray-700 hover:text-emerald-600 font-medium">
            Dashboard
          </Link>
          <Link href="/donor/map" className="text-gray-700 hover:text-emerald-600 font-medium">
            Map View
          </Link>
          <Link href="/donor/analytics" className="text-gray-700 hover:text-emerald-600 font-medium">
            Analytics
          </Link>
          <Link href="/donor/requests" className="text-gray-700 hover:text-emerald-600 font-medium">
            Requests
          </Link>
        </nav>
